...
// Animation variants
const proposalsContainerVariants: Variants = {
  hidden: {},
  show: { transition: { staggerChildren: 0.25, when: "beforeChildren" } },
};

const proposalsItemVariants: Variants = {
        ...
        {isInView && (
          ...
          >
            ...
            <motion.div
              ...
              variants={proposalsContainerVariants}
              initial="hidden"
              animate="show"
              exit="hidden"
            >
              ...
              >
                    ...
                    >
                      <div className="flex justify-between mb-3">
                        <div>
                          ...
                          <span className="text-sm bg-[#F59E0B]/20 px-2 py-0.5 rounded-full text-[#f37669]">
                            {p.category}
                          </span>
                        </div>
                ...
                >
                  ...
                  <motion.div variants={proposalsItemVariants}>
                    <Link href={`/proposals/${selected.id}/vote`}>
                      <Button
                        size="lg"
                        className="w-full bg-gradient-to-r from-[#F59E0B] to-[#D97706] text-white hover:opacity-90"
                        style={{ boxShadow: "0 0 0 2px #D4AF37" }}
                      >
                        Cast Your Vote
                      </Button>
